---
id: portifolio-ascii-engine-product
tipo: arquitetura
status: atual
projeto: portifolio
dominio: product
...
confianca: alta
fontes:
  - Portifolio/wiki/raw-ascii-engine-platform.md
  - Portifolio/wiki/raw-product-decisions.md
relacionados:
  - portifolio-architecture
  - portifolio-current-state
tags:
  - portifolio
  - ascii-engine
---
...
Status: atual (branch `ascii-engine-platform` — repo `/home/gaab/Documentos/gitHub/Portifolio`).
