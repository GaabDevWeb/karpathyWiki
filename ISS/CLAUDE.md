# Wiki Carpaccio — contrato operacional (ISS)
...
- **Projecto documentado:** ISS (repositório `GaabDevWeb/ISS`)
- **Localização desta wiki:** `/home/gaab/Documentos/gitHub/GaabWiki/ISS/` (fora do repositório de código)
- **Código de origem:** `/home/gaab/Documentos/gitHub/ISS` — **não alterar** o código a partir de operações de wiki
...
Pergunta-guia: *O que um agente novo precisaria saber para trabalhar no ISS sem repetir descobertas?*
...
6. **Não alterar o repositório ISS** ao manter esta wiki — escrita apenas sob `GaabWiki/ISS/`
...
### Consultar (antes de implementar no ISS)

1. Ler `index.md`
2. Ler páginas relevantes
3. Confirmar no código do repositório ISS se necessário
...
### Actualizar (após mudança importante no ISS)
...
Órfãs, links quebrados, contradições, duplicados, index desactualizado.
Marcar problemas; não apagar incertezas às cegas.
