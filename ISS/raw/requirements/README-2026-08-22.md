...
4. Com **lições novas publicadas**, envia um embed com disciplina, título da aula, resumo curto, link do [ISS](https://gaabdevweb.github.io/ISS/) e menção em spoiler ao cargo configurado no script.
